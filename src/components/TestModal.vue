          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div
                ...
                <i class="h-6 w-6 text-red-600">!</i>
              </div>
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Deactivate Account</h3>
                <div class="mt-2">
                  <p class="text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi
                    maxime officiis quis cupiditate non accusantium eius, enim nulla necessitatibus quas!</p>
                </div>
              </div>
            </div>
          </div>
